...
# data specifications
parser.add_argument("--dir_image", type=str, default="examples/face/image", help="image dataset directory")
...
parser.add_argument("--pre_train", type=str, default="body_head_recovery/Inpainting/experiments/celebahq/G0000000.pt", help="path to pretrained models")
