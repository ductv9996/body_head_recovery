...
from body_head_recovery.utils import util
...
class Pytorch3dRasterizer(nn.Module):
    ...
    def forward(self, vertices, faces, attributes=None):
        ...
        # torch.save(pix_to_face, "data/body_params/pix_to_face.pt")
        # torch.save(bary_coords, "data/body_params/bary_coords.pt")
...
class SRenderY(nn.Module):
    ...
    def world2uv(self, vertices):
        ...
        batch_size = vertices.shape[0]
        face_vertices = util.face_vertices(vertices, self.faces.expand(batch_size, -1, -1))
        # torch.save(self.faces.expand(batch_size, -1, -1), "data/body_params/face_expand.pt")
